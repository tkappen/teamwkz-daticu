...
from measurement me
    join concept co on co.concept_id = me.measurement_concept_id
    join concept co1 on co1.concept_id = me.measurement_type_concept_id
    join concept co2 on co2.concept_id = me.operator_concept_id
    join concept co3 on co3.concept_id = me.value_as_concept_id
    join concept co4 on co4.concept_id = me.unit_concept_id
    join concept co5 on co5.concept_id = me.measurement_source_concept_id
limit 10
