...
/* pumps from mcg/kg/min calculated as mg per patient with start and end datetime */
SELECT person_id
, drug
, quantity
, start_datetime
...
, date_diff
, unit
, (quantity * ((seconds + (minutes * 60) + (hours * 3600) + (days * 86400)) / 60) / 1000) as mg_administered
